...
async function loadNoblAirRevenueForecast(start, end, daily, ttpCohort) {
  ...
  const ytdActual = {
    ...
    projection_factor: null,
    elapsed_days: null,
    days_in_month: null,
    store_revenue: null,
    orders: null,
    eligible_orders: null,
    eligible_revenue: null,
    aov: null,
    ttp_rate: null,
    activation_rate: null,
    est_activations: null,
    attach_rate: null,
    est_air_orders: null,
    tag_rev_net_est: null,
    sub_rev_net_est: null,
    total_air_rev_net_est: null,
    order_source: `Actual ${firstMonth} through ${forecastAsOf}`,
  };
  ...
  return {
    ...
    full_year: {
      month: 'FULL YEAR FORECAST',
      row_type: 'full_year_forecast',
      status_label: 'Full Year Forecast',
      actual_store_revenue: null,
      actual_orders: null,
      actual_eligible_orders: null,
      actual_eligible_revenue: null,
      actual_rebill_orders: null,
      actual_rebill_revenue: null,
      actual_air_orders: null,
      actual_attach_rate: null,
      actual_ttp_rate: null,
      actual_activation_rate: null,
      actual_tag_rev_net: null,
      actual_sub_rev_net: null,
      actual_rebill_rev_net: null,
      actual_air_rev_net: null,
      ...
      order_source: 'Projected/target full year only; actual YTD is separate row',
    },
  };
}
